...
export default function Navbar() {
    ...
    const navItems = [
        ...
        { name: "Projectos", href: "#projects", icon: <FiFolder /> },
            ...
            <div className="max-w-7xl mx-auto mobile-container">
                <div className="flex justify-between items-center h-14 sm:h-16">
                    ...
                    >
                        ...
                        <span className="text-white font-semibold text-base sm:text-lg">José Mboane</span>
                    </motion.div>
                ...
                {isOpen && (
                    <motion.div
                        ...
                        className="md:hidden py-3 border-t border-gray-700/50"
                    >
